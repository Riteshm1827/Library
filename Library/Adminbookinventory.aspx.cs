    ...
    public partial class Adminbookinventory : System.Web.UI.Page
    {
        ...
        void fillAuthorPublisherValues()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT author_name from author_master_table;", conn);
                ...
                cmd = new SqlCommand("SELECT publisher_name from publisher_master_table;", conn);
        ...
        bool checkIfBookExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from book_master_table where book_ID='" + TextBox1.Text.Trim() + "' OR book_name='" + TextBox2.Text.Trim() + "';", conn);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        void addNewBook()
        {
            try
            {
                ...
                string filepath = "~/book_inventory/Harriet-Books-SEO.png";
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_table(book_ID,book_name,genre,author_name,Publisher_name,publish_date,language,edition,book_cost,no_of_pages,book_description,actual_stock,Current_stock,book_img_link) " +
                    "values(@book_ID,@book_name,@genre,@author_name,@Publisher_name,@publish_date,@language,@edition,@book_cost,@no_of_pages,@book_description,@actual_stock,@Current_stock,@book_img_link)", conn);
        ...
        void deleteBookByID()
        {
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("DELETE from book_master_table WHERE book_ID='" + TextBox1.Text.Trim() + "'", conn);
