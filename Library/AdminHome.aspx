<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="Library.AdminHome" %>
...
@media only screen and (min-width: 1024px) {
  ...
  .our_solution_category {
    ...
    <div class="Ahead" style="background-image: url('../img/Ahome.png'); min-height: 100vh; background-size: cover; min-height: 100vh; position: relative; color: #03fff0; text-shadow: 2px 2px 2px rgba(0,0,0,0.2); filter: brightness(75%);">

        <div class="color-overla d-flex justify-content-between align-items-center">
            <h1 class="animate__animated animate__zoomInDown pl-5" style="font-size: 100px; color: #00FFFF; font-family: Arial;"><u>The-LIB</u>


            </h1>
            <p class="pr-4">

                <span style="font-size: 110px; font-weight: bold; font-family: serif; color: #ffffff;">Welcome Back</span>

                <span class="pl-2" style="font-size: 80px; font-weight: bold; font-family: sans-serif; color: #f2fa92;"></span>
                <br />
                <span style="font-size: 110px; font-weight: bold; font-family: serif; color: #ffffff;">Admin</span>
            </p>
        </div>
    </div>
        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_description">
              <p>
                ...
                <asp:LinkButton ID="LinkButton1" type="button" CssClass="btn read_more_btn btn-light" runat="server" OnClick="LinkButton1_Click">Author List</asp:LinkButton>
          ...
          <div class="solution_card">
            ...
            <div class="solu_description">
              ...
              <asp:LinkButton ID="LinkButton2" type="button" CssClass="btn read_more_btn btn-light" runat="server" OnClick="LinkButton2_Click">Book inventory</asp:LinkButton>
            </div>
          </div>
        </div>
        <!--  -->
          ...
          <div class="solution_card">
            ...
            <div class="solu_description">
              <p>
               ...
               <asp:LinkButton ID="LinkButton3" type="button" CssClass="btn read_more_btn btn-light" runat="server" OnClick="LinkButton3_Click">Book Issuing</asp:LinkButton>
            </div>
          </div>
          <div class="solution_card">
            <div class="hover_color_bubble"></div>
            ...
            <div class="solu_description">
              ...
              <asp:LinkButton ID="LinkButton4" type="button" CssClass="btn read_more_btn btn-light" runat="server" OnClick="LinkButton4_Click">Manage</asp:LinkButton>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_description">
              ...
              <asp:LinkButton ID="LinkButton5" type="button" CssClass="btn read_more_btn btn-light" runat="server" OnClick="LinkButton5_Click">Create--></asp:LinkButton>
            </div>
          </div>
          <div class="solution_card">
            <div class="hover_color_bubble"></div>
            ...
            <div class="solu_description">
              <p>
               ...
               <asp:LinkButton ID="LinkButton6" type="button" CssClass="btn read_more_btn btn-light" runat="server" OnClick="LinkButton6_Click">Check</asp:LinkButton>
            </div>
          </div>
        </div>
        <!--  -->
        <div class="solution_cards_box sol_card_top_3">
          <div class="solution_card">
            ...
            <div class="solu_description">
              ...
              <asp:LinkButton ID="LinkButton7" type="button" CssClass="btn read_more_btn btn-light" runat="server" OnClick="LinkButton7_Click">Add--></asp:LinkButton>
            </div>
          </div>
          <div class="solution_card">
            <div class="hover_color_bubble"></div>
            ...
            <div class="solu_description">
              <p>
               ...
               <asp:LinkButton ID="LinkButton8" type="button" CssClass="btn read_more_btn btn-light" runat="server" OnClick="LinkButton8_Click">Contact Us</asp:LinkButton>
            </div>
          </div>
        </div>
      </div>
